...
# 如已有封面则删除
if not GuiOpt.find_icon(add_url("jianying_fengmian.png")):
    GuiOpt.move_to(160, 808)
    GuiOpt.click_pos(160, 808)
    GuiOpt.enter()
...
# 导入图片
if GuiOpt.find_icon(add_url("jianying_daoru.png")):
    if CommonApi.get_os_type() == "win":
        ...
        if not GuiOpt.find_icon(add_url("jianying_daoruzuidahuachuangkou.png")):
            GuiOpt.double_click_icon(add_url("jianying_xuanzemeitiziyuan.png"))
        GuiOpt.click_icon(add_url("jianying_zhuomian.png"))
...
GuiOpt.click_icon(add_url("jianying_pianwei2.png"))
# GuiOpt.click_icon(add_url("jianying_tianjiayushe.png"))
GuiOpt.click_icon(add_url("jianying_tianjiayushe2.png"))
